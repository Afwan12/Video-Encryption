...
public class BlowfishService implements CryptoAlgorithm {

    private SecretKey key;
    private IvParameterSpec iv;

    // New encryption – generate key + IV
    public BlowfishService() throws Exception {
        generateKeyAndIv();
    }

    // Decryption – use stored key + IV (Base64 strings)
    public BlowfishService(String storedKey, String storedIv) {
    ...
    private void generateKeyAndIv() throws Exception {
        ...
        byte[] ivBytes = new byte[8];        // Blowfish block size = 8 bytes
